    ...
    <>
      <Card className="mb-12">
        <CardHeader className='flex items-center justify-between'>
          ...
          <Button onClick={() => setIsAddDialogOpen(true)} className='bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/100 transition-all'>
            ...
            {doctors.map(doctor => (
              <div key={doctor.id} className='flex items-center justify-between p-4 bg-muted/30 rounded-xl border border-border/50'>
                ...
                <div className='flex items-center gap-3'>
                  ...
                  {doctor.isActive ? (
                    <Badge className='bg-green-100 text-green-500 hover:bg-green-200 transition'>Active</Badge>
                  ) : (
